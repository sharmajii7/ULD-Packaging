...
packer = Packer()
#  init bin 
box = Bin('example3', (3, 2, 1), 100,0,put_type=0)
#  add item
...
packer.addItem(Item(partno='Box-1',name='test',typeof='cube', WHD=(3, 2, 1), weight=1, level=1,loadbear=100, updown=True, color='yellow'))
